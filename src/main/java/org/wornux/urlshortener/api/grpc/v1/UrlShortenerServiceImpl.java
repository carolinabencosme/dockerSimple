...
public class UrlShortenerServiceImpl extends UrlShortenerServiceGrpc.UrlShortenerServiceImplBase {
  ...
  public void createUrl(
    ...
    try {
      ...
      String createdAt =
          new java.text.SimpleDateFormat("dd-MM-yyyy HH:mm:ss").format(created.createdAt());
      ...
      CreateUrlResponse response = CreateUrlResponse.newBuilder().setUrl(ud.build()).build();
      ...
      responseObserver.onError(
          Status.INTERNAL
              .withDescription("Error al crear URL completa: " + e.getMessage())
              .asRuntimeException());
    }
  }
}
